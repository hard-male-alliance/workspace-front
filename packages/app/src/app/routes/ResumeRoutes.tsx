 ...
 * @return 简历列表、创建、编辑、生成导出与模板设置路由 / Resume list, creation, editing, generation/export, and template-settings routes.
...
export default function ResumeRoutes(): React.JSX.Element {
  return (
    <Routes>
      ...
      <Route element={<ResumeOutputPage />} path=":resumeId/export" />
