...
export const MOCK_DAWN_TEMPLATE: UiTemplateManifest = {
  ...
  previewUrl: 'https://api.hmalliances.org/api/v2/resume-templates/tpl_mock_dawn/preview',
...
export const MOCK_EDITORIAL_TEMPLATE: UiTemplateManifest = {
  ...
  previewUrl: 'https://api.hmalliances.org/api/v2/resume-templates/tpl_mock_editorial/preview',
  supportedLocales: ['zh-SG', 'en-US'],
  supportedOutputFormats: ['pdf'],
