...
export const PRODUCTION_TEST_DATA_SENTINELS = Object.freeze([
  ...
  { name: 'knowledge fixture ID', value: 'ks_mock_resume' },
  { name: 'knowledge fixture ID', value: 'ks_mock_git' },
  { name: 'knowledge fixture ID', value: 'ks_mock_blog' },
  { name: 'knowledge fixture ID', value: 'ks_mock_file' },
